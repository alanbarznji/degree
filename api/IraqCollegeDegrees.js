const { c_degreeCollege, g_degreeCollege, u_degreeCollege, d_degreeCollege, gs_degreeCollege } = require("../service/IraqCollegeDegree");
...
const { cr_IraqCollegeDegree, gr_IraqCollegeDegree } = require("../utils/Error/IraqDegreeCollege");
router
  .route("/")
  .post(
    protect,
    toAllow("admin", "user"),
    cr_IraqCollegeDegree,
    Validation,
    c_degreeCollege
  )
  .get(
